...
SECRET_KEY = config('SECRET_KEY', default='your-fallback-secret-key-for-development-only')
...
# Check for DATABASE_URL environment variable (set by Render or local .env)
...
if DATABASE_URL:
    ...
    if 'postgresql' in DATABASE_URL and not DEBUG:
